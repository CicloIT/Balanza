...
export default function GestionApp() {
  ...
  const tabs = [
    ...
    { id: 'pesada', label: '⚖️ Pesada', count: 0 },
  ];
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        {/* Mostrar Alerts - Solo si no estamos en pesada */}
        {activeTab !== 'pesada' && (
          <>
        ...
        {activeTab === 'pesada' ? (
          ...
          <div className={`backdrop-blur-xl transition-colors duration-300 rounded-2xl shadow-2xl overflow-hidden ${
            isDark
      ...
      {/* Modales */}
      {activeTab !== 'pesada' && currentGestion && (
        <ModalForm
